    ...
    <footer className="bg-black text-gray-400 font-medium py-8">
      <section className="container mx-auto flex flex-col md:flex-row items-center justify-between md:px-10 lg:px-52">
        ...
        <div className="flex items-center gap-5 mt-5 md:mt-0">
          ...
          >
            <FaLinkedin className="h-7 w-7 hover:text-cyan-600 transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300"></FaLinkedin>
          </a>
          <a
            ...
            rel="noopener noreferrer"
          >
            <FaGithub className="h-7 w-7 hover:text-cyan-600 transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300"></FaGithub>
          </a>
        </div>
      </section>
    </footer>
